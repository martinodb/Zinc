...
(def SYNTYPE-NEWFN-MAP
  {::Term (eval 'zinc.core/new-term)
   ::Atom (eval 'zinc.core/new-atom)
   ::Base (eval 'zinc.core/new-base)
   ::Variable (eval 'zinc.core/new-variable)
   ::Indefinite (eval 'zinc.core/new-indefinite)
   ::Arbitrary (eval 'zinc.core/new-arbitrary)
   ::QueryVariable (eval 'zinc.core/new-query-variable)
   ::Molecular (eval 'zinc.core/new-molecular)
   ::CARule (eval 'zinc.core/new-carule)
   ::Closure (eval 'zinc.core/new-closure)
   ::Param2op (eval 'zinc.core/new-param2op)
   ::Andor (eval 'zinc.core/new-andor)
   ::Disjunction (eval 'zinc.core/new-disjunction)
   ::Xor (eval 'zinc.core/new-xor)
   ::Nand (eval 'zinc.core/new-nand)
   ::Thresh (eval 'zinc.core/new-thresh)
   ::Equivalence (eval 'zinc.core/new-equivalence)
   ::Conjunction (eval 'zinc.core/new-conjunction)
   ::Negation (eval 'zinc.core/new-negation)
   ::Negationbyfailure (eval 'zinc.core/new-negationbyfailure)
   ::Numericalentailment (eval 'zinc.core/new-numericalentailment)
   ::Orentailment (eval 'zinc.core/new-orentailment)
   ::Implication (eval 'zinc.core/new-implication)
   ::Categorization (eval 'zinc.core/new-categorization)})
