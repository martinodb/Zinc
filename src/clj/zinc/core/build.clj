...
(declare assert            unassert           build check-and-build-variables build-channels build-unifier-channels build-quantterm-channels create-message-structure generic-term? check-and-build-variables)
